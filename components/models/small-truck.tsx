    ...
    <>
      <group>
        <Center scale={[1, 1, 1]} front position={[0, 0, -2]} top {...props}>
          ...
          {/* Cabin */}
          <group position={[0, -0.2, args[2] / 2 + 1.2]}>
            <Cabin
              width={args[0]}
              height={2.2}
              depth={1.8}
              color="#3b82f6"
              wheelArgs={[0.4, 0.4, 0.3]}
            />
          </group>

          {/* Rear Wheels */}
          <group position={[0, 0, -args[2] / 2 + 1.0]}>
            <DoubleWheel
              side="left"
              args={[0.4, 0.4, 0.3]}
              position={[(args[0] - 0.8) / 2, -0.7, 0]}
            />
            <DoubleWheel
              side="right"
              args={[0.4, 0.4, 0.3]}
          ...
          {args[2] > 5 && (
            <group position={[0, 0, -args[2] / 2 + 2.0]}>
              <DoubleWheel
                side="left"
                args={[0.4, 0.4, 0.3]}
                position={[(args[0] - 0.8) / 2, -0.7, 0]}
    ...
    <>
      <group>
        <Center scale={[1, 1, 1]} front position={[0, 0, -2]} top {...props}>
          ...
          {/* Chassis Base */}
          <Box
            args={[args[1] + 1.2, 0.2, args[2] + 2.2]}
            position={[0, -0.1, 1.1]}
            castShadow
            receiveShadow
          >
          ...
          <group position={[0, 0, -args[2] / 2 + 1.0]}>
            <DoubleWheel
              side="left"
              args={[0.4, 0.4, 0.3]}
              position={[args[1] / 2 + 0.15, -0.7, 0]}
            />
            <DoubleWheel
              side="right"
              args={[0.4, 0.4, 0.3]}
              position={[-args[1] / 2 - 0.5, -0.7, 0]}
            />
          </group>
          {args[2] > 5 && (
            <group position={[0, 0, -args[2] / 2 + 2.0]}>
