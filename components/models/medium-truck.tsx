    ...
    <>
      <group>
        <Center scale={[1, 1, 1]} front top position={[0, 0, -2]} {...props}>
          ...
          <group position={[0, 0, (-args[2] / 2 + 6) / 2]}>
            <DoubleWheel
              args={[0.5, 0.5, 0.3]}
          ...
          {args[2] > 7 && (
            <group position={[0, 0, (-args[2] / 2 + 3.5) / 2]}>
              <DoubleWheel
                args={[0.5, 0.5, 0.3]}
                position={[(args[0] - 1) / 2, -0.6, (args[2] - 6.4) / 2]}
              />
    ...
    <>
      <group>
        <Center scale={[1, 1, 1]} front position={[0, 0, -2]} top {...props}>
          ...
          <Box args={[args[1] + 1.5, 0.2, args[2]]} position={[0, 0.1, 0]}>
            <meshStandardMaterial transparent opacity={0.7} color="blue" />
          </Box>
          <group position={[0, 0, (-args[2] / 2 + 6) / 2]}>
            <DoubleWheel
              args={[0.5, 0.5, 0.3]}
              position={[args[1] / 2 + 0.25, -0.6, (args[2] - 6.4) / 2]}
            />
            <DoubleWheel
              args={[0.5, 0.5, 0.3]}
              position={[-args[1] / 2 - 0.6, -0.6, (args[2] - 6.4) / 2]}
            />
          </group>
          {args[2] > 7 && (
            <group position={[0, 0, (-args[2] / 2 + 3.5) / 2]}>
